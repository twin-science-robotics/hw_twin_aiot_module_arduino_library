/* Bilgilendirme
  ...
  Twin AIoT modülünü, Arduino IDE ile programlayabilmek için bazı donanımsal özelliklerini bilmek gerekir.
  ...
  -Giriş Konnektörleri
    ...
    D4 girişi için --> S1 -> 37 
    D8 girişi için --> S2 -> 38 
    D12 girişi için --> S3 -> 14  kullanılır.  

    Eğer giriş modülü dijital bir sensör ise , digitalRead() fonksiyonu ile dijital okuma yapmak istiyorsanız,
      D4 girişi --> 8 
      D8 girişi --> 11
